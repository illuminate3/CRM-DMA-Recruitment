                        ...
                        @if(isset($company))
                            @foreach($company as $c)
                                <tr>
                                    ...
                                    <td><button class="btn btn-block btn-primary activityAdd">New Activity</button></td>
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function() {
            ...
            $('.searchBtn').on('click',function(){
                ...
                window.location = "http://localhost/CRM/public/activity/search?customer="+customerName;
            });
            ...
            $('.activityAdd').on('click',function(){
                ...
                window.location = "http://localhost/CRM/public/activity/add?company="+company;
